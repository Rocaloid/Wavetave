...
function Regenerate(Path, Path2, ShowPlot = 0)
        addpath("../");
        addpath("../Oct");
        addpath("../Util");
        ...
        #Target
        load(strcat("Data/", Path2, ".cvdb"));
        CVDBUnwrap;
        CVDB_FramePosition_2 = CVDB_FramePosition;
        CVDB_Sinusoid_Freq_2 = CVDB_Sinusoid_Freq;
        CVDB_Sinusoid_Magn_2 = CVDB_Sinusoid_Magn;
        CVDB_Residual_2 = CVDB_Residual;
